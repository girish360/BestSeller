...
<head>
 <meta name="viewport" content="initial-scale=1.0, user-scalable=no">
    ...
    <style type="text/css">
	   h1{font-family: "Times New Roman", Times, serif;color:#999999;}
    </style>
...
<body>
     ...
     <script async defer
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDThSZ6NKYA5ENOiz_boagYxLqG9siBBm8&callback=initMap">
