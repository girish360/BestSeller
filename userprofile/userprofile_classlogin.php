   ...
   public function checkemail($array = array()){
	...
	public function registeraccountbusiness($array1 , $array2){
          if (count($array1)==0 && count($array2)==0){
              ...
              $this->db->query("INSERT INTO adminat  set name_company='".$array1['0']."' , emai='".$array1['1']."' , password='".$array1['2']."' , imageprofile='".$array1['3']."' , type_industry='".$array2['0']."' , street_adress='".$array2['1']."', city='".$array2['2']."' , state='".$array2['3']."' , phone_number='".$array2['4']."'") ;
          }
	}
