    ...
    $('.inputsubmit').click(function(){
        ...
        if(radiotypelogin=='1'){//check if is client login 
            if(IsEmail(val)==false){  // check if email is invalid........................................................
                ...
                $.ajax({
                    type:'GET',
                    url: 'userprofile_classlogin.php',
                    data: 'email='+val,
                            ...
                            if(data=='false'){ // if is not register in database , if email exists in database  ................
                                ...
                                $('.loading').animate({ // show loadin ........................................
                                    width:'100%'
                                     ...
                                     if(valtype=='register'){
                                              location.reload();// riderect  in your accounnt ..............
                                       }
       ...
       var valtype=$(this).attr('id');
        ...
        $('.inputsubmit3').click(function(){
            ...
            setTimeout(function(){ 
                ...
                var value='Next Setup';
              
                $('.inputsubmit3').val(value); 
                $('.inputsubmit3').css({
                     background: 'url("") no-repeat center '
                });
      ...
      // start jqury when is on input text and click enter submit button
		...
		function showdiverror(nr){
            ...
            if(nr=='ekzistonemail'){
            	 $('.error').show('fast');
            	 $('.error').append('<div class="valemail">This E-mail  exsist in Database!!</div>');
            }
            if(nr=='gabimtel'){
                 $('.valemail').remove();
            	 $('.error').show('fast');
